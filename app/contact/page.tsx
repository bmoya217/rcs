        ...
        <div className="section-container grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
            ...
            <p className="section-description">
              Call for the fastest response. Share what rooms or surfaces need
              cleaning, whether there are stains or odors, and your preferred
              scheduling window.
            </p>
      ...
      <section className="page-section bg-white">
        <div className="section-container grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div>
            ...
            <p className="section-description">
              Link customers to active profiles so they can verify the business,
              read reviews, and see recent work.
            </p>
          </div>
